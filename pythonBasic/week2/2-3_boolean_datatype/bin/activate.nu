...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/jaehyeokseong/Desktop/jae hyeok document/python_workspace/pythonBasic/week2/2-3_boolean_datatype'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/jaehyeokseong/Desktop/jae hyeok document/python_workspace/pythonBasic/week2/2-3_boolean_datatype/bin/deactivate.nu'
