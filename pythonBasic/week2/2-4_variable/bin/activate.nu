...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/jaehyeokseong/Desktop/jae hyeok document/python_workspace/pythonBasic/week2/2-4_variable'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/jaehyeokseong/Desktop/jae hyeok document/python_workspace/pythonBasic/week2/2-4_variable/bin/deactivate.nu'
